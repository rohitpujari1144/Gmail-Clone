...
function NewHome() {
    ...
    useEffect(() => {
        axios.get(`https://new-be.onrender.com/getEmails/${userEmail}`)
            .then((response) => {
    ...
    function markStarClick(email) {
        ...
        if (emailInfo[0].starred === true) {
            ...
            axios.put(`https://new-be.onrender.com/updateEmailInfo/${email._id}`, updatedEmailDetails)
                .then((response) => {
    ...
    function spamClick(email) {
        ...
        axios.put(`https://new-be.onrender.com/updateEmailInfo/${email._id}`, spamEmail)
            .then((response) => {
