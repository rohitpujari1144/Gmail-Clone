...
function Sidebar() {
    ...
    function modalClose() {
        ...
        if (emailTo.value || emailSubject.value || emailBody.value) {
            ...
            axios.post('https://gmail-clone-email-be.onrender.com/newEmail', draftEmailDetails)
                .then((response) => {
    ...
    const emailDeleteIconClick=()=>{ 
        setModal(false)
        setOpen(true);
        setPopText("Draft discarded")
    }
    return (
        <>
                ...
                <ModalBody>
                    <div className="container border rounded">
                        ...
                        <div className='d-flex justify-content-start mt-3 mb-3' style={{ marginLeft: '75px' }}>
                            ...
                            {/* <input type="file" className="form-control ms-3 w-50"  id="inputGroupFile01"></input> */}
