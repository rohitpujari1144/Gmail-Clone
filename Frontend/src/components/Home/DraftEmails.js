...
function DraftEmails() {
    let [allDraftEmails, setAllDraftEmails] = useState([])
    ...
    useEffect(() => {
        axios(`https://gmail-clone-email-be.onrender.com/getAllDraftEmails/${userEmail}`)
            .then((response) => {
                setAllDraftEmails(response.data)
            });
    }, [allDraftEmails, userEmail])
    ...
    function sendEmailClick(){
        ...
        axios.post('https://gmail-clone-email-be.onrender.com/newEmail', sendingEmailDetails)
            .then((response) => {
                ...
                axios.delete(`https://gmail-clone-email-be.onrender.com/deleteEmail/${viewDraftEmail._id}`)
                    .then((response) => {})
            });
    }
