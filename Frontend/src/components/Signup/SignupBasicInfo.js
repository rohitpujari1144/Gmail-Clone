                ...
                <div className='m-4'>
                    <div className='row'>
                        <div className="col-6">
                            ...
                            <div>
                                <TextField className='mt-2' label="Phone number" id="mobile" size="small" style={{ width: '70%' }} defaultValue={userSignupData.mobile} onKeyUp={() => { mobileValidate() }} />
                            ...
                            <div className='d-flex justify-content-between mt-5' >
                                <div >
                                    <Button variant="text" href="/mobile-verify">Back</Button>
                                </div>
                                <div>
