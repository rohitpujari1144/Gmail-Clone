...
function Signup() {
    ...
    function nextClick() {
        ...
        if (fNameError.innerHTML === '' && lNameError.innerHTML === '' && usernameError.innerHTML === '' && passwordError.innerHTML === '' && cPasswordError.innerHTML === '') {
            let user = getAllUsers.filter((elem) => elem.username === username.value)
            if (user.length) {
                ...
                axios.post('https://gmail-clone-be-zsgo.onrender.com/signup', userSignupData)
                    .then((response) => {
                        sessionStorage.setItem('signupUserEmail', username.value)
                        sessionStorage.setItem('signupUserFirstName', fName.value)
