...
import ForgotEmailCodeEnter from './components/Forgot email/ForgotEmailCodeEnter';
import SignupPhoneNumber from './components/Signup/SignupPhoneNumber';
import SignupMobileVerify from './components/Signup/SignupMobileVerify';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/forgot-email-enter-code' element={<ForgotEmailCodeEnter />} />
